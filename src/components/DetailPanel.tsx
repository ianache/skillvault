...
const LinuxIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2c-1.3 0-2.5 1-2.5 2.5 0 .6.3 1.2.7 1.6C8 7.3 6.5 9.4 6.5 12c0 2.5.8 4.2 1.5 5.1-.3.5-.5 1.1-.5 1.7 0 1.2.8 2.2 2 2.2h5c1.2 0 2-1 2-2.2 0-.6-.2-1.2-.5-1.7.7-.9 1.5-2.6 1.5-5.1 0-2.6-1.5-4.7-3.7-5.9.4-.4.7-1 .7-1.6C14.5 3 13.3 2 12 2zm0 1.5c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm-1.5 6c.4 0 .8.4.8.8s-.4.8-.8.8-.8-.4-.8-.8.4-.8.8-.8zm3 0c.4 0 .8.4.8.8s-.4.8-.8.8-.8-.4-.8-.8.4-.8.8-.8zm-4.3 3c.6-.7 1.6-1 2.8-1s2.2.3 2.8 1c.2.2.1.6-.2.8-.2.2-.6.1-.8-.2-.4-.5-1.1-.6-1.8-.6s-1.4.1-1.8.6c-.2.3-.6.4-.8.2-.3-.2-.4-.6-.2-.8z"/>
  </svg>
);
