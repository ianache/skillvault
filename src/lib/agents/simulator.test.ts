...
test("Simulator detects terraform keywords and triggers terraform-lint steps", async () => {
  const agent: AIAgent = {
    ...
    responsibility: "Identificar y resolver problemas de infraestructura con terraform-lint de forma precisa.",
    deliverables: [],
    owner: "Equipo QA",
    harnesses: ["claude"],
...
test("Simulator detects PR keywords and triggers pr-reviewer steps", async () => {
  const agent: AIAgent = {
    ...
    responsibility: "Revisar cambios de código con calidad y proporcionar retroalimentación constructiva.",
    deliverables: [],
    owner: "Equipo QA",
    harnesses: ["claude"],
